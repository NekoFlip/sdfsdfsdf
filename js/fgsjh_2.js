...
$('.ndg-menu-row').addClass('fixed');
}else{
$('.ndg-menu-row').removeClass('fixed');
}});
});
$('.ndg-overall, .ndg-close').click(function(){
$('.ndg-popup, .testimonial-popup').hide();
$('.ndg-overall').hide();
});
$('#callback, #footer-callback, #callback3').click(function(){
$('#ndg-popup-1').show();
$('.ndg-overall').show();
});
...
$('.footer-menu a, .top-menu li a, .mob-menu li a').click(function(){
$('.mobile-menu').removeClass('show');
$('.mobile-menu-btn').removeClass('cross')
